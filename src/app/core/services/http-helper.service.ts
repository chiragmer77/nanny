...
import { AppConstant, HttpMethodsTypeEnum } from '@app/helpers';
...
export class HttpHelperService {
     ...
     * Revision :
     */
    protected httpHelperMethod(methodType: HttpMethodsTypeEnum, url: string, params = {}, httpOptions: any,
        showToast: boolean, showLoader: boolean, customMessage: string,
        searchParams: any, filesObj: any) {
    ...
    private apiCall(methodType: HttpMethodsTypeEnum, url: string, params = {}, httpOptions: any, searchParams = {}): Observable<any> {
        switch (methodType) {
            ...
            case HttpMethodsTypeEnum.DELETE:
                ...
                return this.http.delete(this.prepareEndpoint(url, params), options);
                break;
        }
    }
